const CACHE='materialcheck-pwa-v1';
const ASSETS=['./','./index.html','./app.js','./pdf-report.js','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./checklisten/index.json','./checklisten/aa-nef.json','./checklisten/san-rucksack-kv.json'];
